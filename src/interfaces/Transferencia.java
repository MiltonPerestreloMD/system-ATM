...
public class Transferencia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton7.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 15)); // NOI18N
        ...
        jButton8.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 15)); // NOI18N
        ...
        jButton9.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 15)); // NOI18N
        ...
        jLabel4.setText("IBAN DO DESTINATÁRIO");

        txtiban.setFont(new java.awt.Font("Berlin Sans FB", 0, 15)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 20)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("VALOR A SE TRANSFERIR");

        txtnome.setFont(new java.awt.Font("Berlin Sans FB", 0, 15)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 20)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("NOME DO DESTINATÁRIO");

        txtvalor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1000 KZ", "2000 KZ", "3000 KZ", "4000 KZ", "5000 KZ", "6000 KZ", "7000 KZ", "8000 KZ", "9000 KZ", "10000 KZ", "20000 KZ", "30000 KZ" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtiban, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtvalor, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String valor = (String) txtvalor.getSelectedItem();
        //JComboBox<String> 

        if (iban.isEmpty() || nome.isEmpty() || valor.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, preencha todos os campos.");
        } else {
            // Logica de transferência (para fins de exemplo, apenas mostramos uma mensagem)
            JOptionPane.showMessageDialog(this, "Transferência realizada com sucesso!");

            // Cria e exibe o recibo
            Recibo recibo = new Recibo(iban, nome, valor);
